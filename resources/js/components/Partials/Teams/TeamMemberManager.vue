      ...
      <FormSection @submitted="addTeamMember">
        ...
        <template #form>
          ...
          <div
            ...
            <div
              class="relative z-0 mt-1 cursor-pointer rounded-lg border-2 border-gray-200 dark:border-gray-600">
              <button
                type="button"
                ...
                :class="{
                  'rounded-t-none border-t-2 border-gray-200 dark:border-gray-600':
                    i > 0,
                ...
                <div
                  ...
                  <div
                    class="mt-2 text-left text-xs text-gray-700 dark:text-gray-500">
                    {{ role.description }}
                  </div>
                </div>
              </button>
    ...
    <DialogModal
      ...
      <template #content>
        <div v-if="managingRoleFor">
          <div
            class="relative z-0 mt-1 cursor-pointer rounded-lg border border-gray-200 dark:border-gray-600">
            <button
              type="button"
              ...
              :class="{
                'rounded-t-none border-t border-gray-200 dark:border-gray-600':
                  i > 0,
                'rounded-b-none': i !== Object.keys(availableRoles).length - 1
              }"
              ...
              <div
                ...
                <div class="mt-2 text-xs text-gray-700 dark:text-gray-500">
                  {{ role.description }}
                </div>
              </div>
            </button>
