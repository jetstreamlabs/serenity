  ...
  <nav
    ...
    <div
      ...
      <component
        ...
        <span class="ml-2 hidden sm:inline">{{ translations.previous }}</span>
      </component>
      <PerPageSelector
      ...
      <component
        ...
        <span class="mr-2 hidden sm:inline">{{ translations.next }}</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-5 w-5 text-gray-400"
          fill="none"
    ...
    <div
      ...
      <div class="flex flex-grow flex-row items-center space-x-4">
        <PerPageSelector
          dusk="per-page-full"
          :value="perPage"
          :options="perPageOptions"
        ...
        <p class="hidden flex-grow text-sm text-gray-700 lg:block">
