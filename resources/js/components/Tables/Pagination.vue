  ...
  <nav
    ...
    <div v-if="hasData" class="flex justify-between flex-1" :class="{ 'sm:hidden': hasLinks }">
      <component
        ...
        class="relative inline-flex items-center px-4 py-2 text-sm font-medium bg-white border border-gray-300 rounded-md"
        ...
        <span class="hidden ml-2 sm:inline">{{ translations.previous }}</span>
      </component>
      ...
      <component
        ...
        class="relative inline-flex items-center px-4 py-2 ml-3 text-sm font-medium bg-white border border-gray-300 rounded-md"
        @click.prevent="onClick(nextPageUrl)">
        <span class="hidden mr-2 sm:inline">{{ translations.next }}</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="w-5 h-5 text-gray-400"
          fill="none"
    ...
    <div v-if="hasData && hasLinks" class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
      <div class="flex flex-row items-center flex-grow space-x-4">
        ...
        <p class="flex-grow hidden text-sm text-gray-700 lg:block">
      ...
      <div>
        <nav class="relative z-0 inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
          <component
            ...
            class="relative inline-flex items-center px-2 py-2 text-sm font-medium bg-white border border-gray-300 rounded-l-md"
            @click.prevent="onClick(previousPageUrl)">
          ...
          <component
            ...
            class="relative inline-flex items-center px-2 py-2 text-sm font-medium bg-white border border-gray-300 rounded-r-md"
            @click.prevent="onClick(nextPageUrl)">
