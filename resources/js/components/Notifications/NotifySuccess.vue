...
<template>
  <Transition
    ...
    <div
      ...
      <div class="bg-emerald-400 p-4 dark:bg-emerald-500">
        <div class="flex items-start">
          ...
          <div class="ml-4 flex flex-shrink-0">
            <button
              type="button"
              @click="emit('close')"
              class="inline-flex text-emerald-900 hover:text-emerald-700 focus:outline-none">
