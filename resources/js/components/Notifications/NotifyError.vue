...
<template>
  <Transition
    ...
    <div
      ...
      <div class="bg-red-400 p-4 dark:bg-red-500">
        <div class="flex items-start">
          <div class="flex-shrink-0">
            <IconOutlineExclamation
              class="h-6 w-6 text-red-900"
              aria-hidden="true" />
          </div>
          <div class="-pt-2 ml-3 w-0 flex-1">
            <p class="text-base font-medium text-red-900">{{ heading }}</p>
          ...
          <div class="ml-4 flex flex-shrink-0">
            <button
              type="button"
              @click="emit('close')"
              class="inline-flex text-red-900 hover:text-red-700 focus:outline-none">
