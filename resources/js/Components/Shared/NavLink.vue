...
const classes = computed(() => {
  return active.value === true
    ? 'inline-flex items-center px-1 pt-1 border-b-2 border-blue-500 text-sm font-medium leading-5 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-contrast-700 transition'
