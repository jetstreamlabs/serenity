...
<template>
  <div>
    <header class="mb-8">
      <h1 class="h2 mb-4 text-gray-800 dark:text-gray-200">How can we help?</h1>
      <p class="text-lg text-gray-600 dark:text-gray-400">
        Everything you need to know right here at your fingertips. Ask questions, browse around for answers, or submit
        your feature requests.
      </p>
    </header>
    <div class="space-y-8 text-gray-600 dark:text-gray-400">
      <!-- Faqs section -->
      <div class="mb-12 space-y-8 md:mb-16">
        <section class="space-y-4">
          <!-- HTML Bookmark -->
          <!-- The data-scrollspy-target attribute makes the scrollspy work -->
          <h2 id="overview" data-scrollspy-target class="h4 scroll-mt-24 text-gray-800 dark:text-gray-200">Overview</h2>
          <ul class="space-y-3">
            <Accordion title="Does Docs support other data sources, like Excel or Airtable?" :open="true">
              <p>
                ...
                by injected humour, or randomised words which don't look. If you are going to use a passage of Lorem
                Ipsum.
              </p>
            </Accordion>
        ...
        <section class="space-y-4">
          <!-- HTML Bookmark -->
          <!-- The data-scrollspy-target attribute makes the scrollspy work -->
          <h2 id="support" data-scrollspy-target class="h4 scroll-mt-24 text-gray-800 dark:text-gray-200">Support</h2>
          <ul class="space-y-3">
        ...
        <section class="space-y-4">
          <!-- HTML Bookmark -->
          <!-- The data-scrollspy-target attribute makes the scrollspy work -->
          <h2 id="security" data-scrollspy-target class="h4 scroll-mt-24 text-gray-800 dark:text-gray-200">
            Security &amp; Privacy
          </h2>
          <ul class="space-y-3">
        ...
        <section class="space-y-4">
          <!-- HTML Bookmark -->
          <!-- The data-scrollspy-target attribute makes the scrollspy work -->
          <h2 id="troubleshooting" data-scrollspy-target class="h4 scroll-mt-24 text-gray-800 dark:text-gray-200">
            Troubleshooting
          </h2>
          <ul class="space-y-3">
