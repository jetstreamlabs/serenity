    ...
    <div class="flex flex-col items-center justify-center md:flex-row md:justify-between">
      <div class="mb-4 md:mb-0">
        <div class="flex shrink-0 flex-col items-center md:flex-row">
          <div class="ml-4 text-sm text-gray-500" v-html="$page.props.copyright" />
        </div>
      </div>
      <!-- Social links -->
      <ul class="inline-flex space-x-2">
        <li>
          <a
            class="flex items-center justify-center text-blue-500 transition duration-150 ease-in-out hover:text-blue-600"
            href="#0"
            aria-label="Twitter">
