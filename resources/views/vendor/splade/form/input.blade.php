...
>
    <label class="block">
        ...
        <div class="flex border border-gray-300 rounded-md shadow-sm dark:border-gray-900">
            @if($prepend)
            ...
            <input {{ $attributes->except(['v-if', 'v-show', 'class'])->class([
                'block w-full border-0 dark:bg-gray-600 dark:text-gray-100 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed',
