...
>
    <template #default="{!! $scope !!}">
        <label class="block">
            ...
            @else
                <a @submit.prevent
                    class="relative inline-block px-3 py-2 text-sm font-semibold text-center text-white uppercase bg-orange-500 border border-orange-600 rounded-md shadow-sm cursor-pointer hover:bg-orange-600 focus:outline-none focus:ring focus:ring-opacity-50 focus:border-orange-300 focus:ring-orange-200">
