<x-splade-toggle :data="true">
    <x-splade-state>
        <div v-if="state.shared.jetstreamBanner && toggled" :class="{
            'bg-blue-500': state.shared.jetstreamBanner.bannerStyle != 'danger',
                ...
                <div class="flex items-center justify-between flex-wrap">
                    <div class="w-0 flex-1 flex items-center min-w-0">
                        <span class="flex p-2 rounded-lg" :class="{
                            'bg-blue-600': state.shared.jetstreamBanner.bannerStyle != 'danger',
                    ...
                    <div class="shrink-0 sm:ml-3">
                        <button
                            ...
                            :class="{
                                'hover:bg-blue-600 focus:bg-blue-600': state.shared.jetstreamBanner.bannerStyle != 'danger',
