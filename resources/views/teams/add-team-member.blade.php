                        ...
                        <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer dark:border-gray-700">
                            @foreach($availableRoles as $role)
                                <button
                                    ...
                                    :class="{'border-t border-gray-200 dark:border-gray-700 rounded-t-none': @json(!$loop->first), 'rounded-b-none': @json(!$loop->last)}"
                                ...
                                >
                                    <div :class='{"opacity-50": form.role && form.role != @json($role->key)}'>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <svg v-if='form.role == @json($role->key)' class="w-5 h-5 ml-2 text-green-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
